...
| Finishes | With nothing selected, the Finishes section sets the exterior wall and roof materials and, per room, the floor (oak, walnut, tiles, carpet, concrete…) and wall paint or tiles. Selecting a wall lets you override its finish. Textures are drawn procedurally and tile at real sizes; the 2D plan tints rooms by their floor. |
